...
abstract class WFACP_Common extends WFACP_Common_Helper {
	...
	public static function registered_page_templates( $paths_existing ) {
		...
		if ( true === apply_filters( 'wffn_add_existing_templates', false, 'checkout' ) && is_array( $paths_existing ) ) {
			$paths = array_merge( $paths, $paths_existing );
		}
