...
class WFACP_Compatibility_With_Theme_Porto {
	...
	public function internal_css() {
		echo '<style>';
		echo '#shipping_calculator_field .border {border: none !important;}';
		echo '#product_switching_field.shop_table {border: none;}';
		echo '#wfacp_qr_model_wrap .single_variation_wrap label.description_label_head {font-weight: bold;}';
		echo '#wfacp_qr_model_wrap .single_variation_wrap {padding-top: 0;margin: 10px 0 0;}';
		echo '</style>';
	}
