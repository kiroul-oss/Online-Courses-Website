...
echo esc_html__( 'Your details', 'bp-custom-order-status' ) . "\n\n";

if ( $billing_email = $order->get_billing_email() ) {
	echo esc_html__( 'Email:', 'bp-custom-order-status' );
	echo esc_html( $billing_email ) . "\n";
}

if ( $billing_phone = $order->get_billing_phone() ) {
	echo esc_html__( 'Tel:', 'bp-custom-order-status' );?> <?php echo esc_html( $billing_phone ) . "\n";
}
